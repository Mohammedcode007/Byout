...
// import { I18nManager, Image, Modal, Pressable, ScrollView, StyleSheet, Text, View } from 'react-native';
...
//   const { isLoggedIn, user } = useAppSelector(state => state.auth); // الحالة الحقيقية من Redux
...
//             <Button 
//               mode="outlined" 
//               style={[styles.loginButton, { backgroundColor: '#fff', borderColor: '#6c5ce7' }]} 
...
//         {/* {isLoggedIn && (
//           <Text style={{ textAlign: 'center', marginBottom: 15, fontSize: 16, color: '#333' }}>
//             مرحبًا، {user?.name || user?.phone}
//           </Text>
//         )} */}
...
const styles = StyleSheet.create({
  ...
  loginButton: { marginTop: -20, backgroundColor: '#6c5ce7', alignSelf: 'center', paddingHorizontal: 30, width: '80%' },
